...
class Activator {
	...
	private static function help_page_content(): string {
		return implode( "\n", [
			...
			'<!-- wp:heading --><h2>Publishing your own words, untouched</h2><!-- /wp:heading -->',
			'<!-- wp:paragraph --><p>Want your title, your message, and your photograph published exactly as you sent them &#8212; no AI-written description, no rewriting, no image correction, ever? Send to the pure address (or put <code>[Pure]</code> at the start of the subject line). Your subject line becomes the title and your message becomes the body, word for word; any attached photo is published exactly as sent.</p><!-- /wp:paragraph -->',
			'<!-- wp:paragraph --><p>The one thing AI still does here is classify the medium and a few tags from what you sent, so your piece stays easy to find on the site and reaches the wider fediverse properly tagged &#8212; it never reads your words to rewrite them, and never touches your photograph.</p><!-- /wp:paragraph -->',
			...
			'<!-- wp:heading --><h2>Limitations</h2><!-- /wp:heading -->',
			'<!-- wp:paragraph --><p>Generating an artwork description with AI can produce content that doesn&#8217;t fully meet your expectations. For this reason, it helps to include a few descriptive details of your own when you send your work &#8212; the more you give AI to work with, the better the result.</p><!-- /wp:paragraph -->',
			'<!-- wp:paragraph --><p>The same applies to translation, in a different way. AI still isn&#8217;t capable of translation quality on par with a human &#8212; it&#8217;s getting closer, but gender and grammatical nuance are often where it falls short. This is why we indicate the artist&#8217;s or author&#8217;s native language on every translated page, giving visitors a way to check it against the native-language version &#8212; the one closest to what the artist actually expressed, or, for the pure address, their exact, unmodified words.</p><!-- /wp:paragraph -->',
		] );
	}
